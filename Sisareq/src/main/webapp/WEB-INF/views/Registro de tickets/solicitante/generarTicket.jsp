<%-- 
    ...
    Created on : 14/10/2016, 01:53:16 AM
    Author     : ULLOA
--%>
...
<c:url value="/solicitante/form_generar_ticket" var="formGenrarTicket"/>
        ...
        <div class="row">
            <div class="col-md-12" >
                <div class="box box-primary">
                    ...
                    <form:form role="form" action="${formGenrarTicket}" method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="prioridades" required="true" id="prioridades">                                                            
