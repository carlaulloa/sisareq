...
<c:url value="/solicitante/form_filtrargen_by_rango" var="formFiltrarByRango"/>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-body"> 
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table aria-describedby="example2_info" role="grid" id="example2" class="order-table table table-bordered table-hover dataTable">
                                                                ...
                                                                <form class="form-horizontal">
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-10">
                                                                                <!-- Link del archivo debe salir el nombre original ala -->
                                                                                <c:choose >
