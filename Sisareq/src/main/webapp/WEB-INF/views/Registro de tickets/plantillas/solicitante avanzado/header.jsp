<%-- 
    Document   : headerSolicitanteAv
    Created on : 24/10/2016, 12:20:06 AM
    Author     : ULLOA
--%>
...
<html>
    <head>
        ...
        <title>Reg Tickets | Solicitante Avanzado</title>
    ...
    <body class="hold-transition skin-green sidebar-mini">
        <c:url value="/solicitanteAv" var = "viewSolicitante"/>
                            ...
                            <ul class="nav navbar-nav">
                                <li class="dropdown user user-menu">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="<c:url value="/resources/img/boss.png"/>" class="user-image" alt="User Image">
